...
export const APP_VERSION = "v0.4.0 Beta";
...
/** 首页 footer 色块文案：LitePan v0.4.0（去掉 Beta 后缀以贴近徽章风格） */
export const APP_VERSION_BADGE = `${APP_NAME} ${APP_VERSION.replace(/\s*Beta$/i, "").trim()}`;
